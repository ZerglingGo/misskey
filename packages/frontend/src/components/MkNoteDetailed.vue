...
import { inject, provide, ref, useTemplateRef, markRaw, computed, defineAsyncComponent } from 'vue';
...
// bscone: load replies and the conversation immediately instead of on demand
loadReplies();
loadConversation();
